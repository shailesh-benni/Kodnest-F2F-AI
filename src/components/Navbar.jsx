...
function Navbar() {
    return (
        <div className='flex items-center justify-between p-2 bg-gray-50 border-b border-gray-200 pl-40 pr-40 mb-2' >
            <div className='flex items-center space-x-4'>
                <img src={logo} alt="KodNest Logo" className='h-8' />
            </div>
            <div className='flex items-center space-x-8 text-sm'>
                <ul className='flex items-center space-x-6 font-medium'>
                    <a href='/' className='flex items-center text-black hover:text-yellow-500 cursor-pointer'>
